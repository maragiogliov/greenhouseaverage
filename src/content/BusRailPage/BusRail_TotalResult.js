...
const BusRailTotalResult = () => {
  ...
  return <>
        <div className='bus-rail-results'>Total Bus & Rail Footprint = <span style={{ marginLeft: '5px', marginRight: '5px' }}>{(totalBusRailFootprint.toFixed(2))}</span> metric tons of CO2e</div>
  </>;
};
